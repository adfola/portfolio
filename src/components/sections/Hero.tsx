      ...
      <div ref={containerRef} className="relative z-10 container mx-auto px-4 py-20">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            >
              <motion.span
                className="inline-block px-4 py-2 bg-primary/20 text-primary rounded-full text-sm font-medium border border-primary/30 cursor-target"
          ...
          >
            ...
            >
              <Button 
                size="lg" 
                className="btn-neon group cursor-target w-full"
