...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A modern student-focused e-commerce platform with integrated voice search capabilities powered by Python. Enables seamless product browsing, secure transactions, and intelligent product discovery. Features a robust backend API with real-time inventory management and scalable architecture.",
      image: campusImage,
    ...
    },
    {
      ...
      image: StreamImage,
      description: "An online Streaming Platform for different purposes like sports,content and so on connected with an external api and build with A fully scalable and modernized Backend and fully functional Api ",
